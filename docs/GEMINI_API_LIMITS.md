...
- **코드 분석**: 현재 코드베이스의 실제 API 호출 패턴 분석
- **사용 모델**: `gemini-2.5-flash` (3개 엔드포인트에서 사용)
- **최신 정보**: 2024년 12월 기준 Gemini API 공식 문서 및 가격 정보
- **업데이트**: 2024년 12월

**참고**: 
- 제한사항과 가격은 Google의 정책에 따라 변경될 수 있습니다
- 최신 정보는 [공식 문서](https://ai.google.dev/pricing)에서 확인하세요
...
| Gemini 2.5 Pro (≤200k 토큰) | $1.25 | $10.00 |
| Gemini 2.5 Pro (>200k 토큰) | $2.50 | $15.00 |

**참고**: 
- Google 검색 그라운딩 기능 사용 시: 1,000개 요청당 $35 추가
- 가격은 변경될 수 있으므로 [공식 문서](https://ai.google.dev/pricing)에서 최신 정보 확인 권장
...
**증빙 적절성 검증:**
- 입력: 6,000-8,000 토큰 → **$0.000002-0.0000024**
- 출력: 200-400 토큰 → **$0.0000005-0.000001**
- **소계: 약 $0.0000025-0.0000035**

**최종 평가:**
- 입력: 8,000-15,000 토큰 → **$0.0000024-0.0000045**
- 출력: 500-1,000 토큰 → **$0.00000125-0.0000025**
- **소계: 약 $0.00000365-0.000007**

**평가 1회 총 비용: 약 $0.000006-0.00001 (약 $0.00001)**

#### Q&A 1회당 비용

- 입력: 2,000-4,000 토큰 → **$0.0000006-0.0000012**
- 출력: 200-800 토큰 → **$0.0000005-0.000002**
- **총 비용: 약 $0.000001-0.000003 (약 $0.000002)**

### 월간 예상 비용 시나리오

#### 시나리오 1: 소규모 사용 (월 100회 평가, 200회 Q&A)
- 평가 비용: 100 × $0.00001 = **$0.001**
- Q&A 비용: 200 × $0.000002 = **$0.0004**
- **총 비용: 약 $0.0014/월 (약 ₩2원)**

#### 시나리오 2: 중규모 사용 (월 1,000회 평가, 2,000회 Q&A)
- 평가 비용: 1,000 × $0.00001 = **$0.01**
- Q&A 비용: 2,000 × $0.000002 = **$0.004**
- **총 비용: 약 $0.014/월 (약 ₩20원)**

#### 시나리오 3: 대규모 사용 (월 10,000회 평가, 20,000회 Q&A)
- 평가 비용: 10,000 × $0.00001 = **$0.10**
- Q&A 비용: 20,000 × $0.000002 = **$0.04**
- **총 비용: 약 $0.14/월 (약 ₩200원)**

#### 시나리오 4: 초대규모 사용 (월 100,000회 평가, 200,000회 Q&A)
- 평가 비용: 100,000 × $0.00001 = **$1.00**
- Q&A 비용: 200,000 × $0.000002 = **$0.40**
- **총 비용: 약 $1.40/월 (약 ₩2,000원)**

### 비용 최적화 팁

1. **캐싱 활용**: 동일한 증빙 자료 재평가 방지로 50-70% 비용 절감 가능
2. **프롬프트 최적화**: 불필요한 컨텍스트 제거로 입력 토큰 20-30% 절감
3. **배치 처리**: 여러 평가를 묶어 처리하여 오버헤드 감소
4. **무료 플랜 활용**: 개발/테스트 환경에서는 무료 플랜 활용

**참고**: 
- 위 비용은 토큰 사용량만 기준으로 계산한 것입니다
- 실제 비용은 Google Cloud Billing에서 확인 가능
- 환율은 $1 = ₩1,400 기준 (2024년 기준)
...
**마지막 업데이트**: 2024년 12월
**문서 버전**: 1.1.0
**분석 기반**: 현재 코드베이스 실제 사용 패턴 분석
**가격 정보**: 2024년 12월 기준 Gemini API 공식 가격
