...
- **예상 비용**: 약 $0.00001/평가 (약 ₩0.014원)

Q&A 1회당:
- **토큰 사용량**: ~2,200-4,800 토큰/질문
- **예상 비용**: 약 $0.000002/질문 (약 ₩0.003원)

### 요금제 가격 (Gemini 2.5 Flash)
...
**월간 예상 비용 예시:**
- 소규모 (100회 평가, 200회 Q&A): 약 ₩2원/월
- 중규모 (1,000회 평가, 2,000회 Q&A): 약 ₩20원/월
- 대규모 (10,000회 평가, 20,000회 Q&A): 약 ₩200원/월
...
**구현 가이드:**
- [Gemini API 제한사항 가이드](./docs/GEMINI_API_LIMITS.md) - 제한사항 및 성능 분석
- [서비스 안정성 구현 가이드](./docs/IMPLEMENTATION_GUIDE.md) - 8가지 핵심 구현사항 상세 가이드
